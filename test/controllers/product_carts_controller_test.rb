...
class ProductCartsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create cart_product" do
    assert_difference('ProductCart.count') do
      post cart_products_url, params: { cart_product: { cart_id: @cart_product.cart_id, products_id: @cart_product.products_id } }
    end

    assert_redirected_to cart_product_url(ProductCart.last)
  end
  ...
  test "should update cart_product" do
    patch cart_product_url(@cart_product), params: { cart_product: { cart_id: @cart_product.cart_id, products_id: @cart_product.products_id } }
