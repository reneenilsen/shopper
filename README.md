...
o	Add product (condition “new” for admin and condition “pre-owned” for general users)
o	Full CRUD method for self-posted products and all products as an admin
o	Full CRUD method for categories if an admin 
-	Search products
...
Signed in users can also just purchase without creating any products of their own. The footer includes link for contacting the admin for the marketplace app as well as links to adding a new product and view/create categories as an admin. 
